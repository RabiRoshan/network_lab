...
if __name__ == "__main__":
	msg=raw_input("Enter the input text : ")
	key=raw_input("Enter the secret key : ")
	print("\n\n-------ENCRYPTING---------\n\n")
	enc_mesage=encrypt(msg,key)
	print("The encrpted text is: "),enc_mesage
	print("\n\n-------DECRYPTING---------\n\n")
	dec_mesage=decrypt(enc_mesage,key)
	print("The decrypted text is: "),dec_mesage
